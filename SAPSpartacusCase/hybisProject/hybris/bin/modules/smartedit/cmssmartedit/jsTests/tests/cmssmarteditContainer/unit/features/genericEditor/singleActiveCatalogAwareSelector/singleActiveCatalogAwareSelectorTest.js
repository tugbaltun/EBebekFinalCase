...
describe('singleActiveCatalogAwareSelector', function() {
    ...
    var CONTEXT_SITE_ID = "some_site_ID";
    ...
    beforeEach(angular.mock.module('singleActiveCatalogAwareItemSelectorModule', function($provide, $compileProvider) {
        ...
        catalogService = jasmine.createSpyObj('catalogService', ['getProductCatalogsBySiteKey']);
        catalogService.getProductCatalogsBySiteKey.and.callFake(function() {
    ...
    it('WHEN singleActiveCatalogAwareSelector renders THEN it initializes properly', function() {
        ...
        // THEN
        expect(catalogService.getProductCatalogsBySiteKey).toHaveBeenCalledTimes(1);
        expect(catalogService.getProductCatalogsBySiteKey).toHaveBeenCalledWith(CONTEXT_SITE_ID);
    });
