...
<div class="container">
    ...
    <div>
        ...
        <ul>
            <li><strong>resources/yempty-items.xml</strong> - here you can model your items</li>
            <li><strong>resources/yempty-spring.xml</strong> - here you can define your services</li>
            <li><strong>web/webroot/WEB-INF/config/yempty-spring-mvc-config.xml</strong> - here is a Spring MVC related
                configuration
            </li>
            <li><strong>web/webroot/WEB-INF/config/yempty-web-app-config.xml</strong> - here you can define web related services,
                facades etc.
            </li>
            <li><strong>web/webroot/WEB-INF/config/yempty-spring-security-config.xml</strong> - here you can configure your Spring Security settings</li>
